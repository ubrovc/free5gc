...
LDFLAGS = -X github.com/ubrovc/util/version.VERSION=$(VERSION) \
          -X github.com/ubrovc/util/version.BUILD_TIME=$(BUILD_TIME) \
          -X github.com/ubrovc/util/version.COMMIT_HASH=$(COMMIT_HASH) \
          -X github.com/ubrovc/util/version.COMMIT_TIME=$(COMMIT_TIME)
